function data = btk_c3d2trc_v5(varargin)
...
%        0.001*(data.fp_data.GRF_data(i).M(:,3)) -0.001*(data.fp_data.GRF_data(i).M(:,1))];
    data.fp_data.GRF_data(i).M =  [data.fp_data.GRF_data(i).M(:,2)/p_sc ...
        data.fp_data.GRF_data(i).M(:,3)/p_sc data.fp_data.GRF_data(i).M(:,1)/p_sc]; 
