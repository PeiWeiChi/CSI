...
%         'LowPassFilterFreq' - low pass filter cutoff frequency for 
...
if isempty(InputDirectory)
    V.InverseDynamicsTool.input_directory = cd;
else V.InverseDynamicsTool.input_directory = InputDirectory;
end
...
% filter
V.InverseDynamicsTool.lowpass_cutoff_frequency_for_coordinates = LowPassFilterFreq;
