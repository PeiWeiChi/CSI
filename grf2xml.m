...
for i = 1:length(ExternalLoadNames)
    ...
    else V.ExternalLoads.objects.ExternalForce(i).point_expressed_in_body = PointExpressedinBody{i}; %%% DC changed ForceExpressedinBody{i} in PointExpressedinBody{i}
    end
