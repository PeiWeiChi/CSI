function static_optim = setup_StaticOptimDG(varargin)
...
% output
DirectoryName = 'StaticOptimization';
OutputPrecision = 12;
...
V.AnalyzeTool.ATTRIBUTE.name = [Model '_' trial '_SO'];
...
V.AnalyzeTool.lowpass_cutoff_frequency_for_coordinates = 6;
...
V.AnalyzeTool.AnalysisSet.objects.StaticOptimization.ATTRIBUTE.name = 'StaticOptimization';
V.AnalyzeTool.AnalysisSet.objects.StaticOptimization.on = AnalysisOn;
V.AnalyzeTool.AnalysisSet.objects.StaticOptimization.start_time = StartTime;
V.AnalyzeTool.AnalysisSet.objects.StaticOptimization.end_time = EndTime;
V.AnalyzeTool.AnalysisSet.objects.StaticOptimization.step_interval = StepInterval;
V.AnalyzeTool.AnalysisSet.objects.StaticOptimization.use_model_force_set = UseModelForceSet;
V.AnalyzeTool.AnalysisSet.objects.StaticOptimization.activation_exponent = ActivationExponent;
V.AnalyzeTool.AnalysisSet.objects.StaticOptimization.use_muscle_physiology = UseFLV;
...
fileout = [Model '_Setup_StaticOptim.xml'];
